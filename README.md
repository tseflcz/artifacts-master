...
事先说明这个评价标准是基于我开服以来的游戏经验，以及诸多大佬的统计数据研究的基础上得来的，有非常多的误差与局限性，仅作抛砖引玉，欢迎各位提出意见与建议，我们一起去完善这个评价体系。这个系统我也打磨了蛮长一段时间，虽然还是有比较多需要完善的地方，但总体自己用下来还算好用，在年前发出来也是作为一个给大家也是给我自己的一个新年礼物，大家2022新年快乐！
...
4. 特别鸣谢：ideles大佬的网页模板与授权，[圣遗物强化助手原帖地址](https://bbs.nga.cn/read.php?tid=29551863)，我前端这块比较菜，主要成果在评分系统的构建上，静态网页部分是在他的圣遗物强化助手网页的基础上加入了自己的评分系统。

### 待更新内容

* 多权重比较功能：即用户可以定义多套权重的功能，灵感来源于[全角色圣遗物胚子评分](https://ngabbs.com/read.php?tid=26432895)。第二套权重可以指定圣遗物套装，计算结果与原权重的计算结果对比后取更高或更低的值。主要用途在于对于特殊角色（说的就是你，不吃双爆的心海小公主！）以及主练角色，我们希望给他留下更适合的圣遗物，而不是与其他角色共用一套评分权重模板，这时候另外定义一套新的权重会是一个不错的解决途径，并且也能一定程度上缓解套装特化的问题（风套对精通需求远高于其他套装）。
...
* 增添/修改/删除单个圣遗物功能：单个圣遗物变动不用再扫描一遍了，这个功能是我的刚需，我是希望能尽快弄出来。但是因为我前端很菜，是自学的vue，可能需要琢磨一段时间，如果难弄的话可能会比较久。
* 历史记录保存功能：主要是配合以上两个较复杂的新功能使用，如果需要每次设置太过麻烦了。这个同上，前端这块我不是很有信心。
