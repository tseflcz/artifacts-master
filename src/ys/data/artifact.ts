...
export default <IAritfactData>{
    ...
    mainDistr: {
        ...
        'goblet': {
            'hpp': 767 / 4000, // 15.34 / 80
            'atkp': 767 / 4000, // 15.34 / 80
            'defp': 766 / 4000, // 15.32 / 80
            'pyroDB': 4 / 80,
            'hydroDB': 4 / 80,
            'electroDB': 4 / 80,
            'anemoDB': 4 / 80,
    ...
    mainWeight: {
        'flower':{'hp': { p: 1, v: 1 }},
        'plume':{'atk': { p: 1, v: 1 }},
        'sands':{'atkp': { p: 0.7170, v: 0.2666 },
                'hpp': { p: 0.1698, v: 0.2666 },
                'defp': { p: 0.0943, v: 0.2666 },
                'er': { p: 0.5094, v: 0.1 },
                'em': { p: 0.2642, v: 0.1 }},
        'goblet':{'atkp': { p: 0.2642, v: 0.2125 },
                'hpp': { p: 0.1321, v: 0.2125 },
                'defp': { p: 0.0755, v: 0.2 },
                'pyroDB': { p: 0.1105, v: 0.05 },
                'hydroDB': { p: 0.1105, v: 0.05 },
                'electroDB': { p: 0.1105, v: 0.05 },
                'anemoDB': { p: 0.1105, v: 0.05 },
                'cryoDB': { p: 0.1105, v: 0.05 },
                'geoDB': { p: 0.1105, v: 0.05 },
                'physicalDB': { p: 0.1105, v: 0.05 },
                'em': { p: 0.1509, v: 0.025 }},
        'circlet':{'atkp': { p: 0.1321, v: 0.22 },
                'hpp': { p: 0.1132, v: 0.22 },
                'defp': { p: 0.0755, v: 0.22 },
                'cr': { p: 0.7925, v: 0.1 },
                'cd': { p: 0.7736, v: 0.1 },
                'hb': { p: 0.1887, v: 0.1 },
                'em': { p: 0.1509, v: 0.04 }},
